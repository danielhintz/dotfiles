...
vim.api.nvim_set_keymap('i', '@kings', 'kwescott cgreenman tmansfield djacobson juchen', {})
vim.api.nvim_set_keymap('i', '@striketeam', 'zparker tcalabrese juchen klipinski pkwiatkowski', {})
